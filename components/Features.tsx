...
export default function Features() {
  return (
    <section id="about" className="bg-[#070E1C] py-24 px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f, i) => (
            <ScrollReveal key={f.title} delay={i * 0.08}>
              <div className="group relative bg-white/[0.03] border border-white/[0.07] rounded-2xl p-6 hover:border-white/20 hover:bg-white/[0.06] transition-all duration-300">
                <div
